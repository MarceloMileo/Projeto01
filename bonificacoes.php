...
$funcionario = new Diretor('Marcelo', new CPF('196.942.318-84'),6431.13);

$funcionario1 = new Gerente('Zé Aruela', new CPF('123.456.789-10'), 1000.00);

$funcionario2 = new Desenvolvedor('Ana Paula', new CPF('123.456.987-09'), 3000.00);
